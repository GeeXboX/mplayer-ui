...
void mpui_focus_index (mpui_focus_box_t *focus_box, int index);
int mpui_focus_get_index (mpui_focus_box_t *focus_box);
void mpui_focus_unfocus (mpui_focus_box_t *focus_box);
